...
defineEmits(['openPost', 'download-resume'])
</script>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div class="flex items-center gap-2">
                <button
                    ...
                    class="inline-flex items-center justify-center rounded-full bg-secondary/15 hover:bg-secondary/25 px-4 py-2 text-xs font-black text-on-secondary-container transition cursor-pointer"
                >
                  📄 Download Resume PDF
                </button>
                <RouterLink
