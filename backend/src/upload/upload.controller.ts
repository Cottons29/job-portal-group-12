...
export class UploadController {
    ...
    async uploadSingle(@UploadedFile() file: Express.Multer.File, @Req() request: Request) {
    ...
    async uploadMultiple(@UploadedFiles() files: Express.Multer.File[], @Req() request: Request) {
    ...
    async proxyFile(
        ...
        const sheepResponse = await this.sheepFileService.fetchFile(filename, range);
